            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form accept-charset="utf-8" method="post" action="{{ url('admin/setting/update') }}"
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-2 custom-text-align">
                                <label for="first_name" class="form-label">Cetificate 1st Part *</label>
                            </div>
                            <div class="col-lg-6">
                                <input type="text" placeholder="Cetificate 1st Part" class="form-control" name="first_part" id="first_part"
                                    value="{{ isset($data->first_part) ? $data->first_part : old('first_part') }}" required>
                                @if ($errors->has('first_part'))
                                    <strong>{{ $errors->first('first_part') }}</strong>
                                @endif
                            </div>
                        </div>
