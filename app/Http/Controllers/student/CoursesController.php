...
class CoursesController extends Controller
{
    ...
    public function courses_list(Request $request)
    {
        ...
        $selected_id = $records[0]->course_id;
        
        //$fullcourse = Auth::user()->id;
        /*$fullcourse = DB::select('SELECT 
                    ...
                    INNER JOIN courses c ON ca.courses_id = 9
        ...
        return view('student.courses.courses_list', compact('lists', 'serial', 'records', 'fullcourse'));
    }
    
    private function get_course_history($course_id, $module_id)
    {
