        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-2">
                    ...
                    <img src="{{ asset('assets/frontend/img/logo.png') }}" style="max-height: 45px;" alt="img">
                    </a>
                </div>
                ...
                <div class="col-md-10">                    
                    <div class="studentMenu">
                        <ul class="list-unstyled">
                            <li class="active">
                                <a href="{{ url('student/dashboard') }}"><i class="fa fa-home" aria-hidden="true"></i> Dashboard</a>
                            </li>
                            ...
                            {{-- <li><a href="{{ url('/student/report') }}" class="{{ Request::segment(2) == 'report' ? 'active' : '' }}"><i class="fa fa-bars"></i>&nbsp;Report</a></li> --}}
