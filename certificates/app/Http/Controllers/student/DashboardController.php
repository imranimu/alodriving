...
class DashboardController extends Controller
{
	...
	public function summary(Request $request)
    {
        ...
        $getTotalModuleComplete =  isset($getModuleHistory) && $getModuleHistory->complete_lession != "" ? count(json_decode($getModuleHistory->complete_lession)) : 0;*/
        
        return view('student.dashboard.summary', compact('diff_day_number', 'getTotalCourseModule', 'course_id'));
    }
