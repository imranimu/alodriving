    ...
    <div class="course-area pb-5">
        <div class="container bg-white py-3">
            <div class="row">
                ...
                <!--</div>-->
                <div class="col-sm-6  courses-title">
                    <h3>{{ $getExamMaster->module_name }}</h3>
                </div>
                    ...
                    @if (!blank($getQuestion))
                        ...
                        @foreach ($getQuestion as $val)
                            ...
                            <div class="col-lg-12 col-md-12">
                                ...
                                <ul class="list-inline question-list" style="display:inline-block;vertical-align: middle;">
                                ...
                                @if ($val->file != '')
                                    <div style="display:inline-block;max-width: 130px;margin-left: 50px;vertical-align: middle;margin-bottom: 1rem;">
                                        <img style="height: 135px; width: 135px;     object-fit: contain;" src="{{ asset('storage/app/public/image/question/' . $val->file) }}"
                                            alt="question-image">
                                    </div>
                                @endif
                            </div>
