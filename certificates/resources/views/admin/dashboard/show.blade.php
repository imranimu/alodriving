                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                    data-target="{{ getCoursesCount() }}">{{ getCoursesCount() }}</span> </h4>
            ...
            <div class="card card-animate">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                    data-target="{{ getCoursesModuleCount() }}">{{ getCoursesModuleCount() }}</span></h4>
            ...
            <div class="card card-animate">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                    data-target="{{ getCoursesLessonCount() }}">{{ getCoursesLessonCount() }}</span> </h4>
                            @if ($userID != 57)
                               <a href="{{ url('admin/course/course-lists') }}" class="text-decoration-underline">View
                                Deatils</a>
                            @endif
            ...
            <div class="card card-animate">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                    data-target="{{ getQuestionCount() }}">{{ getQuestionCount() }}</span> </h4>
                            
                            @if ($userID != 57)
                                <a href="{{ url('admin/question/exam-show') }}" class="text-decoration-underline">View Details</a>
                            @endif
                        </div>
                        <div class="avatar-sm flex-shrink-0">
            ...
            <div class="card card-animate">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                    data-target="{{ getDocumentCount() }}">{{ getDocumentCount() }}</span> </h4>
                            @if ($userID != 57)
            ...
            <div class="card card-animate">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                    data-target="{{ getLicenseCount() }}">{{ getLicenseCount() }}</span></h4>
                            @if ($userID != 57)
            ...
            <div class="card card-animate">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                    data-target="{{ getCertificateGenerateCount() }}">{{ getCertificateGenerateCount() }}</span> </h4>
                            @if ($userID != 57)
            ...
            <div class="card card-animate">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-end justify-content-between mt-4">
                        <div>
                            <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                    data-target="{{ getTodayPaymentAmount() }}">{{ getTodayPaymentAmount() }}</span> </h4>
                            @if ($userID != 57)
